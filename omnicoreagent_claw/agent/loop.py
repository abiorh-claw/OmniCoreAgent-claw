...
from omnicoreagent_claw.agent.tools.spawn import SpawnTool
from omnicoreagent_claw.agent.tools.cron import CronTool
from omnicoreagent_claw.agent.memory import MemoryStore
from omnicoreagent_claw.agent.subagent import SubagentManager
from omnicoreagent_claw.session.manager import Session, SessionManager
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from omnicoreagent_claw.agent.tools.mcp import connect_mcp_servers
