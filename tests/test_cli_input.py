...
from omnicoreagent_claw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("claw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("claw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("claw.cli.commands.PromptSession") as MockSession, \
         patch("claw.cli.commands.FileHistory") as MockHistory, \
